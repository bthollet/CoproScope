...
class PilotageUiTests(unittest.TestCase):
    ...
    def test_template_renders_cards_and_empty_state_without_global_route(self) -> None:
        ...
        self.assertIn("pilotage-summary", html)
        self.assertIn("pilotage-card", html)
        self.assertIn("pilotage-reading", html)
        self.assertIn("pilotage-card-facts", html)
        self.assertIn("Voir le controle complet", html)
        self.assertIn("pilotage-card-action", html)
        ...
        self.assertNotIn("<span>cartes</span>", html)
        self.assertNotIn("<span>domaines</span>", html)
