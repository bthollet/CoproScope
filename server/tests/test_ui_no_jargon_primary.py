...
#: `governance.html` et `governance.py` sont partis avec l'ecran `/gouvernance`,
#: supprime par la recette de Brice du 2026-09-13 (`RM-2026-0183`). Le bandeau
#: de contexte, lui, est sur toutes les pages et reste garde.
TEMPLATE_TARGETS = (
...
class UiNoJargonPrimaryTests(unittest.TestCase):
    def test_context_banner_visible_text_says_coffre_not_vault(self) -> None:
        violations: list[str] = []
