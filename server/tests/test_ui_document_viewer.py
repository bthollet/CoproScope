...
class DocumentViewerUiTests(unittest.TestCase):
    ...
    def test_document_detail_route_renders_synthetic_document(self) -> None:
        ...
        # `RM-2026-0127`, motif dans `web/fiche_document_public.py`.
        self.assertIn(doc["doc_id"], body)
        self.assertNotIn(doc["file_name"], body, "le nom de fichier brut ne doit pas etre rendu")
    ...
    def test_document_detail_never_displays_file_name_as_local_path(self) -> None:
        ...
        self.assertEqual(response.status_code, 200)
        # `RM-2026-0127`: le nom de base ne sort plus non plus.
        self.assertIn(doc_id, body)
        self.assertNotIn("contrat_affichage", body)
