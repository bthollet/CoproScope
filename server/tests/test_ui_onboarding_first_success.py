...
class UiOnboardingFirstSuccessTests(unittest.TestCase):
    ...
    def test_overview_surfaces_first_success_with_token_safe_targets(self) -> None:
        ...
        self.assertIn("prepare une trace locale", text)
        ...
        self.assertIn("Preparer la passation", text)
        ...
        # RM-2026-0183: `/actions` est retire et `/documents/ajouter` debranche: aucun lien n'y mene plus.
        self.assertNotIn('href="/actions', response.text)
        self.assertNotIn('href="/documents/ajouter', response.text)
