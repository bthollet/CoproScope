...
"""
    ...
    def test_generic_extractor_ignores_building_numbers_and_supplier_contacts(self) -> None:
        text = """TY SERVICES 53 Avenue des Exemples 13000 Ville - Telephone : 0600000000 - Courriel : contact@example.test
Designation
Prix Total HT
...
"""
        ...
        oderan = OderanInvoiceProviderExtractor().extract(
            """ODERAN contact@oderan.example
SIRET 923 456 789 00017
Facture N FA31236
Date : 19.05.2025
...
"""
        ...
        self.assertEqual(oderan.siren_siret, "92345678900017")
        self.assertEqual(oderan.numero_facture, "FA31236")
        self.assertEqual(oderan.ht, "2643.00")
        self.assertEqual(oderan.tva, "264.30")
        self.assertEqual(oderan.ttc, "2907.30")
...
CABINET TOMPER DE VIRSAC
"""
        )
        self.assertEqual(insurance.fournisseur, "TOMPER DE VIRSAC")
...
"""
        ...
        self.assertEqual(orange.numero_facture, "0465710386 25A2- 2C01")
    ...
    def test_default_reconciler_uses_text_and_ledger_supplier_evidence(self) -> None:
        invoice = InvoiceReconciliationInput(
            doc_id="DOC-1",
            text="A.M MARCANTELLI RENOVATION\nS.I.R.E.T. 91234567800012\nFacture FC3595",
        ...
        reconciler = DefaultInvoiceReconciler(
            supplier_rules=[
                SupplierRule(
                    supplier="A.M MARCANTELLI RENOVATION",
                    pattern=r"MARCANTELLI|912\s*345\s*678",
                    siren_siret="91234567800012",
                )
            ],
            ledger_lines=[
                "EXERCICE DU 01/01/2025 AU 31/12/2025",
                "16/01/25 FC3595 A.M MARCANTELLI/ RLPT TRONCON WC 1 837,00",
            ],
        )

        result = reconciler.reconcile(invoice)

        self.assertEqual(result.supplier.supplier, "A.M MARCANTELLI RENOVATION")
        self.assertEqual(result.supplier.siren_siret, "91234567800012")
