...
class OderanInvoiceProviderExtractor:
    """Extractor for Oderan invoices."""
    ...
    def extract(self, text: str, file_name: str = "") -> InvoiceExtraction:
        ...
        siren_siret = re.sub(r"\D", "", _first([r"SIRET\s*:?\s*([0-9 .]{14,22})", r"\b(923\s*456\s*789\s*00017)\b"], text))
