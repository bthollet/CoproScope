...
CLASSIFICATION_LABELS = {
    ...
    # Les trois etats de doute, dits en mots de coproprietaire. Sans eux, la
    # piece remontait a l'ecran en portant le jeton brut du code.
    document_intake.CLASSIFICATION_DOUBT: "type a confirmer",
    document_intake.CLASSIFICATION_NO_TEXT: "rien de lisible dans la piece",
    document_intake.CLASSIFICATION_UNKNOWN: "statut non compris, a verifier",
}
