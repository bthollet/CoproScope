...
def _privacy_actions(review_rows: list[dict[str, str]]) -> list[dict[str, str]]:
    ...
    for index, row in enumerate(review_rows):
        # `file_name` en tete de cette liste faisait afficher un patronyme reel
        # sur la premiere carte P0 du cockpit, le 2026-09-07.
        title = row.get("display_file_name") or libelle_public_document(row)
