...
from .core._pipeline_verdict import STATUT_OK, verdict_du_passage
...
def build_parser() -> argparse.ArgumentParser:
    ...
    drive_key_export = drive_subparsers.add_parser(
        "key-export",
        aliases=["exporter-cle"],
        help="Ecrire le code d'acces du coffre dans un fichier temporaire, sans l'afficher.",
    )
    drive_key_export.add_argument("--local-state-root", required=True, help="Etat local de ce poste; doit rester hors Drive et hors Git.")
    drive_key_export.add_argument("--output-file", required=True, help="Fichier temporaire qui recevra le code; son chemin n'est jamais affiche.")
    drive_key_import = drive_subparsers.add_parser(
        "key-import",
        aliases=["importer-cle"],
        help="Lire un code d'acces de coffre depuis un fichier et l'installer sur ce poste.",
    )
    drive_key_import.add_argument("--local-state-root", required=True, help="Etat local de ce poste; doit rester hors Drive et hors Git.")
    drive_key_import.add_argument("--code-file", required=True, help="Fichier contenant le code recu; son chemin n'est jamais affiche.")
