...
`docs/assets/...`; il s'agit d'un brouillon HTML de l'ecran complet (fichier `.html` ou
...
- brouillon HTML cible de l'ecran complet produit pour l'iteration, sauf
...
- brouillon HTML cible de l'ecran complet, ou `VISUEL_IA_WAIVED` justifie;
...
- Le visuel IA est un SVG, un schema partiel ou une illustration abstraite au
  lieu d'un brouillon HTML de l'ecran complet.
