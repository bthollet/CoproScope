...
- Donnees de reference live locale: `C:\Users\brice\CoproScope\instances\tilleul_pseudo_test`; `examples/synthetic_copro` reste la reference publique/CI.
...
1. Recette navigateur explicite sur `tilleul_pseudo_test`: ouvrir manuellement l'URL `ui open-test`, verifier les routes principales et consigner les ecarts sans confondre avec la suite de tests.
