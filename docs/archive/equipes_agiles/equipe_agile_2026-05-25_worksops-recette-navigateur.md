...
```powershell
.\server\.venv\Scripts\python.exe -m coproscope.cli ui open-test --instance-root "C:\Users\brice\CoproScope\instances\tilleul_pseudo_test" --year 2025 --port 8773 --token worksops-live-local
```
