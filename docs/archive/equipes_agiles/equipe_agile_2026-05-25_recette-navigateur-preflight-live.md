...
Verdict: GO execution conditionnel. Le registre canonique indique un serveur reserve `127.0.0.1:8788`, instance `tilleul_pseudo_test`, token `parcours-live-local`, commande `ui open-test`.
