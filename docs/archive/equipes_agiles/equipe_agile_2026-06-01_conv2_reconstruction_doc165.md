...
- Garde-fou securite ajuste: l'OCR local Tesseract de `docai.py` reste dans la liste des usages `subprocess` explicitement relus, sans `shell=True`.
...
- Tests cibles factures/UI factures/DocAI/securite: 30 OK.
- Suite serveur complete: 785 OK, 3 ignores.
