...
```powershell
.\server\.venv\Scripts\python.exe -m coproscope.cli ui open-test --instance-root C:\Users\brice\CoproScope\instances\tilleul_pseudo_test --year 2025 --host 127.0.0.1 --port 8788 --token parcours-live-local
```
...
|---|---|---|---|
| 2026-05-25 15:14 +02:00 | `CONV-2026-1756` | `START_AGILE_RECETTE_PARCOURS_LIVE` | Demande Brice: lancer une equipe agile, vitesse standard. Reprise de `ORD-P0-036` avec serveur visible reserve `8788`, instance `tilleul_pseudo_test`, token `parcours-live-local`; roles lecture seule ouverts, aucun owner code. |
