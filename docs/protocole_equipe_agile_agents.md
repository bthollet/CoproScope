...
justifient une decision. Le visuel est un brouillon HTML de l'ecran complet,
pas un SVG, pas une icone, pas une illustration abstraite et pas un schema
partiel. Le blueprint est le livrable structurel separe.

**Pourquoi un brouillon HTML et non une image.** Arbitrage Brice du 2026-09-07.
Les agents ne generent pas d'image; le repli naturel serait le SVG, et il est
pire que le mal - on perdrait en granularite pour se rapprocher de l'UX deja
developpee, c'est-a-dire qu'on illustrerait l'existant au lieu de proposer une
cible. Un brouillon HTML tient l'intention d'origine mieux qu'une bitmap: il
montre l'ecran complet, il se publie, et surtout il **se clique** - le novice
qualifie un parcours au lieu de commenter une vignette. Il reste un brouillon:
ce n'est pas la page livree, il n'a pas a etre branche sur des donnees reelles,
et il ne dispense pas de la recette sur page reelle apres dev.
...
2. **Visuel IA ET blueprint designer**: requis pour chaque iteration UI avant dev.
   ...
   l'iteration suivante. Le visuel est un brouillon HTML de l'ecran complet
...
- visuel IA livre en SVG, en illustration partielle ou en schema au lieu d'une
  brouillon HTML de l'ecran complet;
...
- chemin ou URL du brouillon HTML cible montrant l'ecran complet,
...
1. le coordinateur lit `CLAUDE.md`, `strategie_equipes_multi_agents.md`, ce
