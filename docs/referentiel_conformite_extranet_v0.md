...
> **CE DOCUMENT EST PERIME.** Il est remplace par
> [`referentiel_conformite_extranet_v1.md`](./referentiel_conformite_extranet_v1.md),
> etabli le 2026-09-04 apres relecture des textes sur Legifrance.
>
> Il est conserve comme trace de l'etat non verifie, et parce que la
> comparaison V0/V1 mesure ce que coute une redaction sans acces aux sources:
> cinq corrections de fond, dont quatre auraient produit des faux manquements.
> Ne pas s'en servir comme grille de controle.
