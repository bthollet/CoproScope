...
3. [Audit360](./audit360.md)
4. [Etat du developpement](./etat_du_developpement.md)
...
| 15 min | ajouter [Fonctions cibles](./fonctions_cibles.md) + [Audit360](./audit360.md) + [Architecture et flux](./architecture_et_flux.md) | une base suffisante pour faire une vraie revue |
