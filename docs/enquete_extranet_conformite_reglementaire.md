...
> **Deux mises a jour depuis la redaction cloud.** Le lot est renumerote
> `RM-2026-0091`: `RM-2026-0047` etait deja pris par le lot Audit des comptes
> bancaires. Et le referentiel joint est remplace par
> [`referentiel_conformite_extranet_v1.md`](./referentiel_conformite_extranet_v1.md),
> ses bases legales ayant ete relues le 2026-09-04.
