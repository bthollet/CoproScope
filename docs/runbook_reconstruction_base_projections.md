...
Exemple pour `tilleul_pseudo_test`:

```powershell
$InstanceRoot = "C:\Users\brice\CoproScope\instances\tilleul_pseudo_test"
$Runtime = Join-Path $InstanceRoot "900_Systeme_Audit\coproscope_runtime"
$Stamp = Get-Date -Format "yyyyMMdd-HHmmss"
$BackupRoot = "C:\Users\brice\CoproScope\dev\instance_support\sauvegardes\tilleul_pseudo_test\$Stamp"
