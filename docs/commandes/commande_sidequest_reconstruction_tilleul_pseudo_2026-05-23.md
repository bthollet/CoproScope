# Commande sidequest - reconstruction progressive Tilleuls (pseudo)
...
dossier tilleul_pseudo. La simulation doit aller jusqu'a l'integration complete de
toutes les pieces primaires du dossier Tilleuls (pseudo) reel.
...
humains, et `Affiche tilleul_pseudo.pdf`.
...
- Produire:
  - `rapport_comparaison_reconstruction_tilleul_pseudo_2026-05-23.md`;
...
Le rapport final `rapport_comparaison_reconstruction_tilleul_pseudo_2026-05-23.md`
doit commencer par:

- verdict `GO`, `GO sous reserve` ou `NO-GO`;
- reponse en une phrase a la question: l'instance test reconstruit-elle
  correctement le dossier Tilleuls (pseudo) reel ?
