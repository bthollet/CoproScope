...
# `clients` est entre le 2026-09-07. L'extension navigateur y vit depuis le
# 2026-09-04 - 1941 lignes de JavaScript, HTML et CSS - et la regle du depot
# vise explicitement "sources applicatives, tests, templates, CSS, scripts et
# configurations maintenus dans le depot". Un garde-fou qui ne regarde pas ou
# le code est ecrit ne garde rien: il rend un vert qui se lit comme une
# couverture. Au moment de l'ajout, le plus gros fichier de `clients` compte
# 360 lignes.
SCOPED_ROOTS = ("server", "tools", ".github", "clients")
SCOPED_SUFFIXES = (
    ".py",
    ".pyfrag",
    ".html",
